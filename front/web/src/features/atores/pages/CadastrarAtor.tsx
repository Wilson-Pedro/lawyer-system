...
import { atoresService, AtorRequest } from '../';
...
export default function CadastrarAtor() {
...
*/
    ...
    const handleSalvar = async (dados: AtorRequest, setError: UseFormSetError<AtorRequest>) => {
        try {
            await atoresService.cadastrar(dados);
            // Se deu certo: mostra sucesso e volta para a página anterior após 2 segundos
            setToast({ mostrar: true, mensagem: "Ator cadastrado com sucesso!", variante: "success" });
    ...
    return (
        <Container>
                <h2 className="mb-4 text-center">Cadastrar Ator</h2>

                <Form<AtorRequest> onSubmit={handleSalvar}>
                  ...
                  {/*  <Select
                    ...
                    />
                  */}
                    <Input name="tipoAtor" label="Tipo" />
                    <Input name="usuarioStatus" label="Status" />
