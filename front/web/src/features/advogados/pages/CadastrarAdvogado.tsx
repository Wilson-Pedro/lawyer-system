...
*/
    ...
    const handleSalvar = async (dados: AdvogadoRequest, setError: UseFormSetError<AdvogadoRequest>) => {
        try {
            await advogadosService.cadastrar(dados);
            // Se deu certo: mostra sucesso e volta para a página anterior após 2 segundos
            setToast({ mostrar: true, mensagem: "Advogado cadastrado com sucesso!", variante: "success" });
    ...
    return (
        <Container>
                <h2 className="mb-4 text-center">Cadastrar Advogado</h2>

                <Form<AdvogadoRequest> onSubmit={handleSalvar}>
