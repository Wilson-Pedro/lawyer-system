...
*/
    ...
    const handleSalvar = async (dados: AssistidoRequest, setError: UseFormSetError<AssistidoRequest>) => {
        try {
            await assistidosService.cadastrar(dados);
            // Se deu certo: mostra sucesso e volta para a página anterior após 2 segundos
            setToast({ mostrar: true, mensagem: "Assistido cadastrado com sucesso!", variante: "success" });
