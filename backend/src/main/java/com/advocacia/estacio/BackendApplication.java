...
public class BackendApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		DemandaDto demandaDto = new DemandaDto(null, "Atualizar Processos", estagiarioId, professorId, advogadoId, "Corrigido", "Corrigido", "02/12/2025", 10, "Dentro do Prazo");
		DemandaDto demandaDto2 = new DemandaDto(null, "Organizar Processos", estagiarioId2, professorId, advogadoId, "Em Correção", "Aguardando Professor", "03/12/2025", 12, "Dentro do Prazo");
